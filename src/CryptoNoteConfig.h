...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 95; // addresses start with "R"
...
const char     CRYPTONOTE_NAME[]                             = "huycoin";
...
const char     P2P_STAT_TRUSTED_PUB_KEY[] = "13467628927eaa0b13a4e52e61864a75aa475e67f6b5748eb3fc1d2fe468aed4";
